<script>
    ...
    let one, oneOne, oneTwo, oneTwoOne, oneTwoTwo, oneTwoThree, oneTwoFour, oneTwoFive, oneThree, oneFour;
...
<div class="constitution">
    ...
    <h3 class="noUnderscore clickable" on:click={() => goToSection(one)}>Section 1: Roster</h3>
        ...
        <h4 class="noUnderscore clickable" on:click={() => goToSection(oneFour)}>1.4 New</h4>
    ...
    <h3 bind:this={oneFour}>1.3 New</h3>
